...
Os scripts que ele usava continuavam lá, intactos. Rodei todos, e todos falharam igual:
...
Ele voltou no formato que a queda tinha ensinado. Quem me manda mensagem sem eu pedir agora são scripts burros, sem modelo nenhum no meio: medem, comparam com um limite e só falam quando o estado muda. O modelo ficou com a parte de que eu sentia falta — responder quando eu pergunto.
